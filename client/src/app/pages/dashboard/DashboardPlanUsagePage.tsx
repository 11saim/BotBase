        ...
        <div className="relative overflow-hidden rounded-3xl border border-[var(--border-default)] bg-[var(--bg-primary)] px-6 py-10 shadow-[0_1px_3px_rgba(0,0,0,0.04)] sm:px-10 sm:py-12">
          ...
          <div className="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              >
                One place to see how your workspace compares to your current
                plan limits.
              </p>
            </div>
            <div
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              When you outgrow Pro, you can move to a higher tier for more
              messages, bots, and storage. Billing is not wired in this preview
              build.
            </p>
          </div>
          <div
