        ...
        <div className="w-full max-w-[360px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full h-[36px] rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-700 flex items-center justify-center gap-2 transition-all hover:bg-gray-50 active:scale-[0.98] disabled:opacity-50"
            >
